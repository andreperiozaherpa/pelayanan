...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-xl font-black text-slate-800 dark:text-white tracking-tight uppercase">Edit Desa</h1>
            <p class="text-xs text-slate-500 font-medium tracking-tight">Perbarui informasi wilayah untuk desa <strong>{{ $village->name }}</strong>.</p>
        </div>
    </div>
