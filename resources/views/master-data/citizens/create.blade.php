...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-xl font-black text-slate-800 dark:text-white tracking-tight uppercase">Tambah Data Warga</h1>
            <p class="text-xs text-slate-500 font-medium tracking-tight">Registrasi Data Induk dan Status Kemiskinan.</p>
        </div>
    </div>
    ...
    <div class="premium-card p-6 sm:p-10 relative overflow-hidden">
        <form action="{{ route('citizens.store') }}" method="POST">
            ...
            <div class="mt-10 pt-6 border-t border-black/[0.03] dark:border-white/[0.03] flex items-center justify-end gap-3">
