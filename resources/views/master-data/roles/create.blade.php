...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-xl font-black text-slate-800 dark:text-white tracking-tight uppercase">Tambah Role</h1>
            <p class="text-xs text-slate-500 font-medium tracking-tight">Definisikan nama peran dan pilih izin akses yang sesuai.</p>
        </div>
    </div>
                ...
                <div class="grid grid-cols-1 gap-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required
                            ...
                            placeholder="MISAL: SUPERVISOR WILAYAH" />
                    </div>
