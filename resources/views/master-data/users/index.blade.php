                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-slate-100/50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-700/50">
                            <th class="py-4 px-6 text-xs font-black text-slate-500 uppercase tracking-widest">User
                                Information</th>
                            <th class="py-4 px-6 text-xs font-black text-slate-500 uppercase tracking-widest">Role &
                                Authority</th>
                    ...
                    <tbody class="divide-y divide-slate-200 dark:divide-slate-700/50">
                        @forelse($users as $user)
                            <tr class="hover:bg-white/60 dark:hover:bg-slate-800/60 transition-colors group">
                                ...
                                <td class="py-4 px-6">
                                    <span
                                        class="px-2.5 py-0.5 rounded-lg text-[10px] font-black uppercase tracking-widest bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-white/5">
                                ...
                                <td class="py-4 px-6">
                                    @if ($user->is_active)
                                        <span
                                            class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20">
                                            Active
                                        </span>
                                    @else
                                        <span
                                            class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest bg-rose-500/10 text-rose-600 dark:text-rose-400 border border-rose-500/20">
                                            Inactive
                                        </span>
                                    @endif
                                </td>
