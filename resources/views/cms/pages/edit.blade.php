...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-xl font-black text-slate-800 dark:text-white tracking-tight uppercase">Edit Halaman</h1>
                <p class="text-xs text-slate-500 font-medium tracking-tight">Perbarui informasi halaman statis
                    "{{ $cmsPage->title }}".</p>
            </div>
        </div>
                ...
                <div
                    ...
                    <div class="space-y-2">
                        <label
                            ...
                            Halaman</label>
                        <input type="text" name="title" id="page-title" value="{{ old('title', $cmsPage->title) }}" required
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="slug" id="page-slug" value="{{ old('slug', $cmsPage->slug) }}"
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="content" id="editor" rows="15" required
                            ...
                            placeholder="Tulis konten halaman di sini...">{{ old('content', $cmsPage->content) }}</textarea>
                        @error('content')
                            <p class="text-[10px] text-rose-500 font-bold mt-1 uppercase tracking-tight">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="meta_title"
                                value="{{ old('meta_title', $cmsPage->seo?->meta_title) }}"
                                class="w-full px-5 py-3.5 bg-slate-50 dark:bg-slate-900/50 border border-black/[0.03] dark:border-white/[0.03] rounded-2xl focus:ring-2 focus:ring-primary-acorn/20 focus:border-primary-acorn text-[11px] font-bold transition-all dark:text-white"
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="url" name="canonical_url"
                                value="{{ old('canonical_url', $cmsPage->seo?->canonical_url) }}"
                                class="w-full px-5 py-3.5 bg-slate-50 dark:bg-slate-900/50 border border-black/[0.03] dark:border-white/[0.03] rounded-2xl focus:ring-2 focus:ring-primary-acorn/20 focus:border-primary-acorn text-[11px] font-bold transition-all dark:text-white"
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="meta_description" rows="3"
                            class="w-full px-5 py-3.5 bg-slate-50 dark:bg-slate-900/50 border border-black/[0.03] dark:border-white/[0.03] rounded-2xl focus:ring-2 focus:ring-primary-acorn/20 focus:border-primary-acorn text-[11px] font-bold transition-all dark:text-white"
                            placeholder="Deskripsi singkat konten halaman untuk hasil pencarian Google...">{{ old('meta_description', $cmsPage->seo?->meta_description) }}</textarea>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="meta_keywords"
                            value="{{ old('meta_keywords', $cmsPage->seo?->meta_keywords) }}"
                            class="w-full px-5 py-3.5 bg-slate-50 dark:bg-slate-900/50 border border-black/[0.03] dark:border-white/[0.03] rounded-2xl focus:ring-2 focus:ring-primary-acorn/20 focus:border-primary-acorn text-[11px] font-bold transition-all dark:text-white"
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                let slugEdited = slugInput ? (slugInput.value !== '') : false;
