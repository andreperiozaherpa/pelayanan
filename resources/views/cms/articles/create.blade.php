...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-xl font-black text-slate-800 dark:text-white tracking-tight uppercase">Tulis Artikel</h1>
                <p class="text-xs text-slate-500 font-medium tracking-tight">Tulis konten artikel baru lengkap dengan
                    optimasi SEO metadata.</p>
            </div>
        </div>

        <form action="{{ route('cms-articles.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="content" id="editor" rows="15" required
                            ...
                            placeholder="Tulis isi artikel Anda di sini...">{{ old('content') }}</textarea>
                        @error('content')
                            <p class="text-[10px] text-rose-500 font-bold mt-1 uppercase tracking-tight">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="meta_description" rows="3"
                            class="w-full px-5 py-3.5 bg-slate-50 dark:bg-slate-900/50 border border-black/[0.03] dark:border-white/[0.03] rounded-2xl focus:ring-2 focus:ring-primary-acorn/20 focus:border-primary-acorn text-[11px] font-bold transition-all dark:text-white"
                            placeholder="Deskripsi singkat konten artikel untuk hasil pencarian Google...">{{ old('meta_description') }}</textarea>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="status" required
                                class="w-full px-5 py-3.5 bg-slate-50 dark:bg-slate-900/50 border border-black/[0.03] dark:border-white/[0.03] rounded-2xl focus:ring-2 focus:ring-primary-acorn/20 focus:border-primary-acorn text-[11px] font-bold transition-all dark:text-white">
                                <option value="draft" {{ old('status') === 'draft' ? 'selected' : '' }}>DRAFT / TANGGUH
                                </option>
