            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        <div
                            class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-300 group-focus-within:text-[#3498db] transition-colors">
                ...
                <div class="flex items-center justify-between px-1">
                    <label class="flex items-center group cursor-pointer">
                        ...
                        <span
                            class="ml-2 text-[10px] font-black text-slate-400 uppercase tracking-widest group-hover:text-slate-600 transition">Ingat
                            saya</span>
                    </label>
                    <a href="#"
                        class="text-[10px] font-black text-[#3498db] uppercase tracking-widest hover:opacity-80 transition">Lupa
                        sandi?</a>
                </div>
