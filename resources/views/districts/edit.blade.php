...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white/40 dark:bg-slate-800/40 backdrop-blur-xl border border-white/50 dark:border-slate-700/50 rounded-[2.5rem] shadow-2xl overflow-hidden">
        <div class="p-8 sm:p-12">
            <div class="mb-10">
                <h1 class="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Edit Kecamatan</h1>
                <p class="text-slate-500 mt-2 font-medium">Perbarui informasi wilayah untuk kecamatan <strong>{{ $district->name }}</strong>.</p>
            </div>
