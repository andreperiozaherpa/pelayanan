...
@section('title', 'Tambah Zona Fungsi')

@section('content')
<div class="space-y-6">
    <div>
        <h1 class="text-xl font-black text-slate-800 dark:text-white tracking-tight uppercase">Tambah Zona Fungsi</h1>
        <p class="text-xs text-slate-500 font-medium tracking-tight">Buat overlay tata ruang baru untuk membagi wilayah berdasarkan fungsinya.</p>
    </div>

    <div class="premium-card p-6 md:p-8">
        <form action="{{ route('map-zones.store') }}" method="POST" class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            @csrf
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="Contoh: Kawasan Industri Way Kenanga Barat" required
            ...
            <div class="flex flex-col gap-3">
                <div>
                    ...
                    <p class="text-[10px] text-slate-400 font-medium">Gunakan alat gambar di peta untuk melukis poligon luas zona fungsi tata ruang.</p>
                </div>
