...
@section('title', 'Tambah Loket MPP')
...
<div class="max-w-2xl mx-auto space-y-8">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-xl font-black text-slate-800 dark:text-white tracking-tight uppercase">Tambah Loket</h1>
            <p class="text-xs text-slate-500 font-medium tracking-tight">Tambahkan loket (counter) baru untuk MPP.</p>
        </div>
    </div>

    <div class="premium-card">
        <div class="p-8 sm:p-12">
            <form method="POST" action="{{ route('counters.store') }}" class="space-y-6">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    <select name="gerai_id"
                        ...
                        @foreach($gerais as $gerai)
                            <option value="{{ $gerai->id }}" {{ old('gerai_id') == $gerai->id ? 'selected' : '' }}>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="description" rows="3"
                        ...
                        placeholder="Deskripsi loket (opsional)">{{ old('description') }}</textarea>
                </div>
