...
@section('title', 'Tambah Anjungan MPP')
...
<div class="max-w-2xl mx-auto space-y-8">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-xl font-black text-slate-800 dark:text-white tracking-tight uppercase">Tambah Anjungan</h1>
            <p class="text-xs text-slate-500 font-medium tracking-tight">Tambahkan anjungan (kiosk) baru untuk MPP.</p>
        </div>
    </div>

    <div class="premium-card">
        <div class="p-8 sm:p-12">
            <form method="POST" action="{{ route('anjungans.store') }}" class="space-y-6">
                @csrf
