    ...
    <div class="space-y-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div class="flex items-center gap-3">
                <div
                    class="px-4 py-2.5 bg-white dark:bg-slate-900 border border-black/[0.03] dark:border-white/[0.03] rounded-2xl shadow-sm flex items-center gap-3">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <!-- Total Verifications -->
            <div class="premium-card p-6 flex items-center gap-5 group hover:-translate-y-1 transition duration-300">
                <div class="w-12 h-12 rounded-2xl bg-primary-acorn/10 flex items-center justify-center text-primary-acorn">
                ...
                <div>
                    ...
                    <p class="text-xl font-black text-slate-800 dark:text-white mt-0.5 tabular-nums">
            ...
            <div class="premium-card p-6 flex items-center gap-5 group hover:-translate-y-1 transition duration-300">
                ...
                <div>
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Status Valid</p>
                    <p class="text-xl font-black text-emerald-500 mt-0.5 tabular-nums">
            ...
            <div class="premium-card p-6 flex items-center gap-5 group hover:-translate-y-1 transition duration-300">
                ...
                <div>
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Kadaluarsa</p>
                    <p class="text-xl font-black text-amber-500 mt-0.5 tabular-nums">
            ...
            <div class="premium-card p-6 flex items-center gap-5 group hover:-translate-y-1 transition duration-300">
                ...
                <div>
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Unmapped</p>
                    <p class="text-xl font-black text-rose-500 mt-0.5 tabular-nums">
                    ...
                    <div class="relative z-10 space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-3">
                            <a href="{{ route('reports.citizens') }}"
                                class="flex items-center justify-between p-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl transition duration-300 group/btn">
                    ...
                    <div class="space-y-4">
                        @foreach ($stats['recent_requests'] as $req)
                            <div class="premium-card p-4 flex items-center gap-4 group">
                                <div
                                    class="h-10 w-10 rounded-xl bg-slate-50 dark:bg-slate-900 flex items-center justify-center text-[10px] font-black text-slate-400 group-hover:text-primary-acorn transition">
