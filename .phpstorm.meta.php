...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/andre/Developer/Laravel/svldk/public/storage' => 'string',
...
'broadcasting.connections.log.driver','broadcasting.connections.null.driver','concurrency.default','view.paths','view.compiled',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/andre/Developer/Laravel/svldk/public/storage',
...
'citizens.index','citizens.store','citizens.show','citizens.update','citizens.destroy','poverty.index','poverty.store','login','logout','dashboard.index','dashboard.verify','dashboard.history',
'dashboard.proof','api.verification.check','service.store','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'auth.login','dashboard.history','dashboard.index','dashboard.proof','dashboard.verify',
'layouts.app','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'laravel-exceptions::503','laravel-exceptions::layout','laravel-exceptions::minimal','notifications::email','pagination::bootstrap-3',
...
'SERVER_NAME','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER',
'HASH_DRIVER','BCRYPT_ROUNDS','LOG_CHANNEL','LOG_STACK','LOG_DEPRECATIONS_CHANNEL',
'LOG_LEVEL','DB_CONNECTION','DB_HOST','DB_PORT','DB_DATABASE',
'DB_USERNAME','DB_PASSWORD','DB_SOCKET','SESSION_DRIVER','SESSION_LIFETIME',
